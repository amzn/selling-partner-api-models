...
namespace Amazon.SellingPartnerAPIAA.Client.Model
{
    ...
    public partial class EventFilter : AggregationFilter,  IEquatable<EventFilter>, IValidatableObject
    {
        ...
        public EventFilter(MarketplaceIds marketplaceIds = default(MarketplaceIds), string eventFilterType = default(string), MarketplaceIds marketplaceIds = default(MarketplaceIds), AggregationSettings aggregationSettings = default(AggregationSettings)) : base(aggregationSettings)
        {
