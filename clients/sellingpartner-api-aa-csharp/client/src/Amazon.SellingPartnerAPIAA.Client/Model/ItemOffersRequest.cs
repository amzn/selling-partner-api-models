...
namespace Amazon.SellingPartnerAPIAA.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemOffersRequest : BatchRequest, IEquatable<ItemOffersRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public ItemOffersRequest(string marketplaceId = default(string), ItemCondition itemCondition = default(ItemCondition), CustomerType customerType = default(CustomerType), string uri = default(string), HttpMethod method = default(HttpMethod), HttpRequestHeaders headers = default(HttpRequestHeaders)) : base(uri, method, headers)
        {
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
            {
                throw new InvalidDataException("marketplaceId is a required property for ItemOffersRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("itemCondition is a required property for ItemOffersRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ItemOffersRequest);
        }

        /// <summary>
        /// Returns true if ItemOffersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemOffersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemOffersRequest input)
        {
            if (input == null)
                return false;
