...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Notifications
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketplaceFilter :  IEquatable<MarketplaceFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplaceFilter" /> class.
        /// </summary>
        /// <param name="marketplaceIds">marketplaceIds.</param>
        public MarketplaceFilter(MarketplaceIds marketplaceIds = default(MarketplaceIds))
        {
        ...
        {
            return this.Equals(input as MarketplaceFilter);
        }

        /// <summary>
        /// Returns true if MarketplaceFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketplaceFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketplaceFilter input)
        {
            if (input == null)
                return false;
